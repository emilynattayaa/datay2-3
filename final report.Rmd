...
```
Grouping and isolating parts of the data will make it easier to look at and cross examine the household composition and how it varies across different ethnicity groups in Britain. In egoalt8, we want to keep the relationship of individuals in the household along with their sex whilst sorting into groups those that are in married or cohabiting and those that are single oe not cohabiting. 
...
Looking at plots of these different data sets 
